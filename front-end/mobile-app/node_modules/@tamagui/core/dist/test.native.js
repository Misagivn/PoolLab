...
var require_insertStyleRule_native = __commonJS({
  "../web/dist/cjs/helpers/insertStyleRule.native.js"(exports2, module2) {
    ...
    var bailAfterEnv = process.env.TAMAGUI_BAIL_AFTER_SCANNING_X_CSS_RULES, bailAfter = bailAfterEnv ? +bailAfterEnv : 250, sheet = null;
  ...
  "../web/dist/cjs/hooks/useTheme.native.js"(exports2, module2) {
    ...
    var useTheme = function() {
      ...
      var keys = import_react3.default.useRef([]), changedThemeState = useChangeThemeEffect(props, !1, keys.current, import_constants.isServer ? void 0 : function() {
        ...
        return next;
      }), themeManager = changedThemeState.themeManager, state = changedThemeState.state, themeProxied = import_react3.default.useMemo(function() {
